...
@interface TFY_ContextImageView : UIView

/**
 The context type to use when loading the context.
 */
@property (assign, nonatomic) TFYContextType contextType;

/**
 The context type is TFYContextTypeEAGL. And the large image that needs to be zoom. GLKView will be added to the first position of the contentView. Otherwise, the large image will become blurred after zoom in.
 */
@property (weak, nonatomic) UIView *contentView;

/**
 The TFY_Context that hold the underlying CIContext for rendering the CIImage's
 ...
 */
@property (strong, nonatomic) TFY_Context *__nullable context;
