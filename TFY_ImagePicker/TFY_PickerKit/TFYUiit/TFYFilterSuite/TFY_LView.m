...
@interface TFY_LViewContext : NSObject <CALayerDelegate>
...
@implementation TFY_LViewContext
...
@interface TFY_LTiledLayer : CATiledLayer

@end

@implementation TFY_LTiledLayer
...
@property (nonatomic, strong) TFY_LViewContext *context;

@end

@implementation TFY_LView

+ (Class)layerClass
{
    return [TFY_LTiledLayer class];
}
