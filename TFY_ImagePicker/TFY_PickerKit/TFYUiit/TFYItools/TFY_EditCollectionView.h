...
typedef NSString * _Nonnull (^TFYEditCollectionViewDequeueReusableCellBlock)(NSIndexPath * _Nonnull indexPath);
typedef void (^TFYEditCollectionViewCellConfigureBlock)(NSIndexPath * _Nonnull indexPath, id _Nonnull item, UICollectionViewCell * _Nonnull cell);
typedef void (^TFYEditCollectionViewDidSelectItemAtIndexPathBlock)(NSIndexPath * _Nonnull indexPath, id _Nonnull item);

@protocol TFYEditCollectionViewScrollDelegate<NSObject>
@optional
...
@protocol TFYEditCollectionViewDelegate<TFYEditCollectionViewScrollDelegate>
@optional
- (void)collectionView:(UICollectionView *)collectionView didEndDisplayingCell:(UICollectionViewCell *)cell forItemAtIndexPath:(NSIndexPath *)indexPath;
@end

@protocol TFYEditCollectionViewDelegateFlowLayout<TFYEditCollectionViewDelegate>
@optional
...
@interface TFY_EditCollectionView : UIView
...
@property(nullable,nonatomic,weak) id<TFYEditCollectionViewDelegate>        delegate;                       // default nil. weak reference
