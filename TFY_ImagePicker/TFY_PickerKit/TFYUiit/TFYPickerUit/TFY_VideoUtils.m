...
//    CFTimeInterval time = CACurrentMediaTime();
    ...
    if ([presetName isEqualToString:AVAssetExportPresetLowQuality]) {
        ...
        preset = TFYAssetExportSessionPreset720P;
    } else if ([presetName isEqualToString:AVAssetExportPreset1920x1080]) {
        preset = TFYAssetExportSessionPreset1080P;
        ...
        preset = TFYAssetExportSessionPreset4K;
    }
    
    TFY_AssetExportSession *exportSession = [[TFY_AssetExportSession alloc] initWithAsset:asset preset:preset];
