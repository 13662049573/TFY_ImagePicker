//
//  TFY_CGContextDrawTextBackground.m
//  WonderfulZhiKang
//
...
TFYCGContextDrawTextBackgroundStringKey const TFYCGContextDrawTextBackgroundTypeName = @"TFYCGContextDrawTextBackgroundTypeName";
TFYCGContextDrawTextBackgroundStringKey const TFYCGContextDrawTextBackgroundColorName = @"TFYCGContextDrawTextBackgroundColorName";
TFYCGContextDrawTextBackgroundStringKey const TFYCGContextDrawTextBackgroundRadiusName = @"TFYCGContextDrawTextBackgroundRadiusName";
TFYCGContextDrawTextBackgroundStringKey const TFYCGContextDrawTextBackgroundLineUsedRectsName = @"TFYCGContextDrawTextBackgroundLineUsedRectsName";
TFYCGContextDrawTextBackgroundStringKey const TFYCGContextDrawTextBackgroundTextContainerSizeName = @"TFYCGContextDrawTextBackgroundTextContainerSizeName";

static inline void picker_CGContextChangedBlendModelClear(CGContextRef cg_nullable c, BOOL isClear, UIColor * _Nullable backgroundColor)
{
    if (isClear) {
...
void picker_CGContextDrawTextBackgroundSolid(CGContextRef cg_nullable c, UIColor  * _Nullable backgroundColor, CGFloat radius, NSArray <NSValue *>*usedRects)
{
    picker_CGContextChangedBlendModelClear(c, NO, backgroundColor);
...
void picker_CGContextDrawTextBackgroundBorder(CGContextRef cg_nullable context, UIColor  * _Nullable backgroundColor, CGFloat radius, NSArray <NSValue *>*usedRects)
{
    CGFloat R = 0;
    CGFloat lineWidth = 0;
    for (int i = 0; i < usedRects.count; i ++) {
        ...
        R = cur.size.height * radius;
        lineWidth = R * 0.25;
        picker_CGContextChangedBlendModelClear(context, NO, backgroundColor);
        ...
        if (i > 0) {
            ...
            if (a.x - c.x >= 2*R) {
                picker_CGContextChangedBlendModelClear(context, YES, backgroundColor);
...
void picker_CGContextDrawTextBackground(CGContextRef cg_nullable c, UIColor  * _Nullable backgroundColor, CGFloat radius, NSArray <NSValue *>*usedRects, TFYCGContextDrawTextBackgroundType type)
{
    switch (type) {
        case TFYCGContextDrawTextBackgroundTypeBorder:
            picker_CGContextDrawTextBackgroundBorder(c, backgroundColor, radius, usedRects);
            break;
        case TFYCGContextDrawTextBackgroundTypeSolid:
            picker_CGContextDrawTextBackgroundSolid(c, backgroundColor, radius, usedRects);
            break;
        default:
            break;
    }
...
void picker_CGContextDrawTextBackgroundData(CGContextRef cg_nullable c, CGSize size, NSDictionary *data)
{
    UIColor *backgroundColor = [data objectForKey:TFYCGContextDrawTextBackgroundColorName];
    CGFloat radius = [[data objectForKey:TFYCGContextDrawTextBackgroundRadiusName] floatValue];
    NSArray <NSValue *>*usedRects = [data objectForKey:TFYCGContextDrawTextBackgroundLineUsedRectsName];
    TFYCGContextDrawTextBackgroundType type = [[data objectForKey:TFYCGContextDrawTextBackgroundTypeName] integerValue];
    NSValue *textContainerSizeValue = [data objectForKey:TFYCGContextDrawTextBackgroundTextContainerSizeName];
    ...
    picker_CGContextDrawTextBackground(c, backgroundColor, radius, usedRects, type);
}
